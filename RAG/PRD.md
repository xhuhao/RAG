...
#### 数据采集要求
- **数据来源**：广西师范大学官网、教务处、研究生院、图书馆、学生工作处、招生就业处
- **robots.txt状态**：学校网站未设置robots.txt，没有明确禁止爬虫
- **爬取策略**：低频率爬取，遵守爬虫礼仪
- **频率限制**：每次请求间隔3-5秒，每天最多爬取50篇
- **爬取时间**：建议在凌晨或深夜爬取，避开高峰期
- **User-Agent**：使用正常的浏览器User-Agent
- **异常处理**：遇到403/429等错误时暂停爬取，记录日志
